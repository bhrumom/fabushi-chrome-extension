# Fabushi Chrome Extension — Agent Instructions

These instructions apply repository-wide to AI-assisted development in `bhrumom/fabushi-chrome-extension`.

## CRITICAL: Repository ownership

This repository is the canonical source for **Chrome extension and browser-control integration**.
